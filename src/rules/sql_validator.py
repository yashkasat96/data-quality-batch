...
class DataComparator():
   ...
   def compare(self, source, target):
    ...
    def compare_counts(self, source, target):
        source_total_record_list = [getUniqueId(), self.job_id, self.sourceEntityName, self.targetEntityName
        ...
        self.summary = self.summary.union(
            getSparkSession().createDataFrame([source_total_record_list], summary_schema()))
